...
const numPeople = getPeopleData().length;
...
So far, research by the ${numPeople} current and former members of CSDL has led to ${journal} journal, ${conference} conference, and ${workshop} workshop publications, as well as ${phd} Ph.D. theses, ${ms} M.S. theses, and ${bs} undergraduate honors theses.  
`;
